    ...
    <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            <div class="xez-card p-4 p-lg-5">
                ...
                <button class="btn xez-btn-cyan w-100 py-3 fw-bold mb-3" id="btn_regis">
                ...
                <div class="text-center">
                    <p class="text-muted small mb-0">
                        ยังไม่มีบัญชี?
                        <a href="?page=register" class="text-xez-primary fw-bold">สมัครสมาชิก</a>
                    </p>
                </div>
            </div>
        </div>
