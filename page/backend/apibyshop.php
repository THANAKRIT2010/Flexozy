...
<div class="p-4 p-lg-5">
    <div class="mb-5">
        <h3 class="fw-bold text-dark mb-1"><i class="fa-solid fa-receipt text-xez-primary me-2"></i>
            ตั้งค่าระบบ SlipOK API</h3>
        <p class="text-muted small">กำหนดข้อมูล SlipOK API Key, Branch ID และบัญชีรับเงินสำหรับตรวจสอบสลิปโอนเงินอัตโนมัติ</p>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="card border-0 bg-light rounded-4 p-4 mb-4">
                <h5 class="fw-bold text-dark mb-3"><i class="fa-solid fa-key text-xez-primary me-2"></i> SlipOK API Credentials</h5>
                
                <div class="mb-4">
                    <label class="form-label text-dark fw-bold small">SlipOK API Key</label>
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fa-solid fa-key text-muted"></i></span>
                        <input type="text" id="slip_api_key" class="form-control border-start-0 py-3" value="<?php echo htmlspecialchars($setting['slip_api_key'] ?? ''); ?>"
                            placeholder="เช่น SLIPOKX0VSODQ" style="border-radius: 0 12px 12px 0;">
                    </div>
                    <div class="form-text text-muted small mt-1">คัดลอกรหัส API Key จากระบบ SlipOK มาวางที่นี่</div>
                </div>

                <div class="mb-3">
                    <label class="form-label text-dark fw-bold small">SlipOK URL / Branch ID</label>
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fa-solid fa-link text-muted"></i></span>
                        <input type="text" id="slip_api_branch" class="form-control border-start-0 py-3" value="<?php echo htmlspecialchars($setting['slip_api_branch'] ?? ''); ?>"
                            placeholder="เช่น 71124" style="border-radius: 0 12px 12px 0;">
                    </div>
            ...
            <div class="card border-0 bg-light rounded-4 p-4 mb-4">
                <h5 class="fw-bold text-dark mb-3"><i class="fa-solid fa-building-columns text-xez-primary me-2"></i> ข้อมูลบัญชีธนาคารสำหรับโอนเงิน</h5>

                <div class="mb-3">
                    <label class="form-label text-dark fw-bold small">เลือกธนาคาร</label>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label class="form-label text-dark fw-bold small">ชื่อจริงเจ้าของบัญชี</label>
                ...
                <div class="mb-3">
                    <label class="form-label text-dark fw-bold small">เลขบัญชีธนาคาร</label>
            ...
            <button class="btn btn-success w-100 py-3 fw-bold shadow-sm" id="subm"
                style="background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); border: none; border-radius: 12px;">
                <i class="fa-solid fa-save me-2"></i> บันทึกข้อมูล SlipOK API
            </button>
        </div>
    </div>
</div>
